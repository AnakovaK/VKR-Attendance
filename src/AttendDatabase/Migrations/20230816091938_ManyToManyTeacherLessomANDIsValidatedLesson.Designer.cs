...
namespace AttendDatabase.Migrations
{
    ...
    [Migration("20230816091938_ManyToManyTeacherLessomANDIsValidatedLesson")]
    partial class ManyToManyTeacherLessomANDIsValidatedLesson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RTUAttendAPI.AttendDatabase.Models.TeacherLesson", b =>
                {
                    ...
                    b.Property<Guid>("FkLessonId")
                        .HasColumnType("uuid")
                        .HasColumnName("fk_lesson_id");

                    b.Property<Guid>("FkTeacherId")
                        .HasColumnType("uuid")
                        .HasColumnName("fk_teacher_id");

                    b.HasKey("Id");

                    b.HasIndex("FkLessonId");
            ...
            modelBuilder.Entity("RTUAttendAPI.AttendDatabase.Models.TeacherLesson", b =>
                {
                    b.HasOne("RTUAttendAPI.AttendDatabase.Models.Lesson", "FkLessonTeacher")
                        .WithMany("Teachers")
                        .HasForeignKey("FkLessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("lessons_fk_teachers_foreign");

                    b.HasOne("RTUAttendAPI.AttendDatabase.Models.Teacher", "FkTeacherLesson")
                        .WithMany("Lessons")
                    ...
                    b.Navigation("FkLessonTeacher");

                    b.Navigation("FkTeacherLesson");
                });
