...
namespace AttendDatabase.Migrations
{
    ...
    [Migration("20230731140445_DisciplineToVisitLogUpdate")]
    partial class DisciplineToVisitLogUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("discipline_visiting_log", b =>
                {
                    ...
                    b.Property<Guid>("VisitingLogsId")
                        .HasColumnType("uuid")
                        .HasColumnName("visiting_logs_id");

                    b.HasKey("DisciplineId", "VisitingLogsId");

                    b.HasIndex("VisitingLogsId");

                    b.ToTable("discipline_visiting_log");
                });
